...
export const projects = [
  ...
  { id: 9, title: 'Brand Campaign — Automotive', category: 'Commercial', tag: 'Color • Edit', videoUrl: '/V.4.mp4' },
  { id: 10, title: 'Brand Campaign — Automotive', category: 'Commercial', tag: 'Color • Edit', videoUrl: '/V.5.mp4' }
].map((project) => ({
  ...project,
